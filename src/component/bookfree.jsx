...
const BookFree = () => {
    ...
    useEffect(() => {
        document.title = "Book a Free Demo - Slashr HR Software Solutions";

        // Update Meta Description
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute("content", "Schedule a free demo with Slashr and explore our HR solutions.");
        } else {
            const newMeta = document.createElement("meta");
            newMeta.name = "description";
            newMeta.content = "Schedule a free demo with Slashr and explore our HR solutions.";
