    ...
    return (
        <>
            <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300  ${isScrolled ? "bg-white/80 backdrop-blur-md shadow-md" : "bg-white "}`}>
                <div className={`bg-[#2a6171] text-white text-center py-3 ${isScrolled ? 'sm:hidden' : 'block'} hidden sm:block`}>
                    <h1 className="text-xs font-bold">
                        🚀  Experience Next-Level HR with SlasHR .{' '}
                        <Link to="/book-a-free-demo" className="underline cursor-pointer">
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-8 sm:p-8">
                    ...
                    <button
                        ...
                        type="button"
                        className="inline-flex items-center cursor-pointer  p-2 w-10 h-10 justify-center text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
